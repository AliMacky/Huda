...
class NotificationManager {
    ...
    private func schedulePrayersForDay(
        date: Date,
    ...
    private func schedulePrayerNotification(
        ...
        if let location = locationManager.effectiveLocationTitle {
            content.body =
                "It's time for \(prayer.localizedName) prayer in \(location)"
        } else {
        ...
        case .athan:
            ...
            content.sound = UNNotificationSound(
                named: UNNotificationSoundName(soundFile)
            )
        }
    ...
    private func notificationIdentifier(for prayer: Prayer, on date: Date)
        -> String
    {
    ...
    func sendTestNotification() async {
        ...
        content.sound = UNNotificationSound(
            named: UNNotificationSoundName("takber-alkatamy.caf")
        )
