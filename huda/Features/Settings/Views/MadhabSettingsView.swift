        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 24) {
                        ...
                        ForEach(MadhabPreference.allCases) { madhab in
                            Button(action: {
                                ...
                                HStack {
                                    ...
                                    if settingsManager.selectedAsrMadhab
                                        == madhab
                                    {
                    ...
                    Text(
                        "The Asr calculation method differs based on the Madhab. The Hanafi school uses a later time for Asr compared to the other schools."
                    )
                    .font(.footnote)
